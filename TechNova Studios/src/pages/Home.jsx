...
const Home = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Built to grow with your business needs and future requirements",
    },
    {
      icon: Heart,
    ...
    },
    {
      icon: Headphones,
      title: "24/7 Support",
      description: "Dedicated support and maintenance for peace of mind",
    },
  ];
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-bold rounded-2xl hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300"
              >
                View Projects
              </motion.button>
            </motion.div>
...
<section className="py-20 relative bg-slate-950">
  ...
  <div className="container mx-auto px-4 relative z-10">
    <motion.div
      ...
      className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto" // Changed to 3 columns and centered
    >
      {stats.map((stat, index) => (
        <motion.div
          key={stat.label}
          variants={itemVariants}
          className="text-center p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 backdrop-blur-sm group hover:border-cyan-400/30 transition-all duration-300"
        >
          <div className="w-12 h-12 bg-cyan-400/10 rounded-xl flex items-center justify-center mb-4 mx-auto group-hover:bg-cyan-400/20 transition-colors">
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                <motion.div
                  ...
                  className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700/50 backdrop-blur-sm rounded-2xl p-6 hover:border-cyan-400/30 transition-all duration-300 h-full"
                >
                  <div className="w-12 h-12 bg-cyan-400/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-cyan-400/20 group-hover:scale-110 transition-all duration-300">
          ...
          >
            {projects.map((project, index) => (
              ...
              >
                <motion.div
                  variants={cardHoverVariants}
                  className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700/50 backdrop-blur-sm rounded-2xl overflow-hidden group cursor-pointer hover:border-cyan-400/30"
                >
          ...
          >
            <Link to="/projects">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-bold rounded-2xl hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300 flex items-center gap-2 mx-auto"
              >
                View All Projects
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </motion.button>
      ...
      <section className="py-20 relative overflow-hidden bg-slate-950">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-400/30 rounded-2xl p-8 md:p-12 text-center backdrop-blur-sm"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-bold rounded-2xl hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300 flex items-center gap-2"
              >
